!function(e, t) {
    ...
    : function(e) {
      ...
      , W = void 0
      , U = function(e) {
        ("string" == typeof e.target && !document.querySelector(e.target) || "string" != typeof e.target && !e.target.appendChild) && (console.warn('SweetAlert2: Target parameter is not valid, defaulting to "body"'),
        e.target = "body");
        var t = void 0
          , r = c()
        ...
        for (var a in e)
            $.isValidParameter(a) || console.warn('SweetAlert2: Unknown parameter "' + a + '"');
        ...
        e.progressSteps.length ? (P(V),
        T(V),
        O >= e.progressSteps.length && console.warn("SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        ...
        if (e.type) {
            ...
            e.animation)
                ...
                case "success":
                    ...
                    E(K.querySelector(".swal2-success-line-tip"), "swal2-animate-success-line-tip"),
                    E(K.querySelector(".swal2-success-line-long"), "swal2-animate-success-line-long");
                    break;
                case "error":
                    E(K, "swal2-animate-error-icon"),
                    E(K.querySelector(".swal2-x-mark"), "swal2-animate-x-mark")
                }
        }
        var D = v();
        e.imageUrl ? (D.setAttribute("src", e.imageUrl),
        P(D),
        e.imageWidth ? D.setAttribute("width", e.imageWidth) : D.removeAttribute("width"),
        e.imageHeight ? D.setAttribute("height", e.imageHeight) : D.removeAttribute("height"),
        D.className = n.image,
        e.imageClass && E(D, e.imageClass)) : L(D),
        ...
        e.buttonsStyling && (x.style.backgroundColor = e.confirmButtonColor,
        ...
        e.buttonsStyling ? (E(x, n.styled),
        E(S, n.styled)) : (A(x, n.styled),
        A(S, n.styled),
        ...
        e.showLoaderOnConfirm && !e.preConfirm && console.warn("SweetAlert2: showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://limonte.github.io/sweetalert2/#ajax-request")
    }
      , z = function(e, t) {
        var o = u()
          , r = c();
      ...
      , $ = function e() {
        ...
        case "object":
            ...
            break;
        default:
            return console.error('SweetAlert2: Unexpected type of argument! Expected "string" or "object", got ' + I(o[0])),
            !1
        }
        U(l);
        var s = u()
        ...
        return new Promise(function(t, o) {
            ...
            }, M = d.querySelectorAll("button"), O = 0; O < M.length; O++)
                M[O].onclick = T,
                M[O].onmouseover = T,
                M[O].onmouseout = T,
                M[O].onmousedown = T;
            ...
            var K = function(e, t) {
              ...
              , D = function(n) {
                ...
                if (-1 !== [9, 13, 32, 27, 37, 38, 39, 40].indexOf(i)) {
                    ...
                    r.stopPropagation(),
                    r.preventDefault()) : 37 === i || 38 === i || 39 === i || 40 === i ? document.activeElement === N && q(R) ? R.focus() : document.activeElement === R && q(N) && N.focus() : 13 === i || 32 === i ? -1 === u && l.allowEnterKey && (V(l.focusCancel ? R : N),
                    r.stopPropagation(),
            ...
            e.hideLoading = e.disableLoading = function() {
                l.showConfirmButton || (L(N),
                l.showCancelButton || L(g())),
                A(H, n.loading),
                A(d, n.loading),
                N.disabled = !1,
                R.disabled = !1
            ...
            l.inputOptions.then(function(t) {
                e.hideLoading(),
                G(t)
            })) : "object" === I(l.inputOptions) ? G(l.inputOptions) : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + I(l.inputOptions))),
    ...
    $.setDefaults = function(e) {
        ...
        for (var t in e)
            $.isValidParameter(t) || (console.warn('SweetAlert2: Unknown parameter "' + t + '"'),
            delete e[t]);
        R(K, e)
    }
    ,
